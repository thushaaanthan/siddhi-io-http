...
public class HttpsClient {
    ...
    public ArrayList<String> passwordGrandAccessToken(String url, String trustStorePath, String trustStorePassword,
        ...
        HashMap<String, String> headers = setHeaders(encodedAuth);
    ...
    public ArrayList<String> refreshGrandAccessToken(String url, String trustStorePath, String trustStorePassword,
        ...
        if (statusCode == HttpConstants.SUCCESS_CODE) {
            ...
            return clientGrandAccessToken(url, trustStorePath, trustStorePassword, encodedAuth);
        } else {
            tokenResponse.add(response.get(0));
            return tokenResponse;
        }
    ...
    public ArrayList<String> clientGrandAccessToken(String url, String trustStorePath, String trustStorePassword,
                                                    String encodedAuth) {
        String token;
        ArrayList<String> serverInfo = getServerInfo(url);
        HttpWsConnectorFactory factory = new DefaultHttpWsConnectorFactory();
